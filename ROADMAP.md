...
| 2. DGP port | Port all four DGPs (pharma, cpg, saas, linear) plus the two specialty DGPs (pharma_adstock, geo_panel) to R. With seed = 42 they produce panels numerically equivalent to the Python ones. | pending |
