...
The R port aims to reproduce the headline attribution-share MAPE from
the Python paper within multi-seed standard error. At Phase 7, this
README will display the side-by-side numbers.
